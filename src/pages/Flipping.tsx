...
const Flipping = () => {
  const projects = [{
    ...
    highlights: ["382 Horsepower Reliable 5.5L V8 Engine", "Modern safety features", "Moderate interior condition", "Complete restoration work finished"],
    image: e550Coupe,
    sold: true
  }];
  return <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6 animate-fade-in">Car Sales</h1>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            step: "1",
            title: "Acquisition",
            desc: "Carefully select vehicles with potential"
          }, {
            step: "2",
            title: "Assessment",
            desc: "Thorough inspection and restoration plan"
          }, {
            step: "3",
            title: "Restoration",
            desc: "Professional detailing and repairs"
          }, {
            step: "4",
            title: "Sale",
            desc: "Quality vehicles at fair prices"
          }].map(item => <Card key={item.step}>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-8 max-w-5xl mx-auto">
            {projects.map((project, index) => <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Project Image */}
                    <div className="h-80 md:h-auto overflow-hidden md:rounded-l-lg relative">
                      <img src={project.image} alt={project.title} className="w-full h-full object-cover" />
                      {project.sold && <div className="absolute top-4 right-4">
                    ...
                    <div className="p-6 md:p-8">
                      ...
                      {project.price && <p className="text-2xl font-bold text-accent mb-4">{project.price}</p>}
                      ...
                      <div className="space-y-4">
                        ...
                        {project.features && <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                              {project.features.map(feature => <Badge key={feature} variant="secondary">
                                  {feature}
                                </Badge>)}
                            </div>
                          </div>}
                        ...
                        {project.highlights && <div>
                            ...
                            <div className="space-y-2 mt-2">
                              {project.highlights.map(highlight => <div key={highlight} className="flex items-start gap-2 text-sm">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {["Transparent Process", "Quality Craftsmanship", "Fair Pricing"].map(item => <div key={item} className="flex items-center justify-center gap-2">
